<?php
    ...
    //////////////////////////-----Users--------/////////////////////////////
    class users{
        private $uid,$name,$emil,$password,$profilePicture,$con;
        ...
        function update(){
            $query="update users set name='".$this->name."',email='".$this->email."',password='".$this->password."',profilePicture='".$this->profilePicture."' where uid='".$this->uid."';";
            mysqli_query($this->con,$query);
        }
        function insert(){
            $query="insert into users values(null,'".$this->name."','".$this->email."','".$this->password."','".$this->profilePicture."');";
            mysqli_query($this->con,$query);
        }
        function delete(){
...
/////////////////////-----------Room--------------///////////////////
class Room{
    private $rid,$roomNumber,$EXT,$con;
    function __construct(){
    ...
    function update(){
        $query="update Room set roomNumber='".$this->roomNumber."',EXT='".$this->EXT."' where rid='".$this->rid."';";
        mysqli_query($this->con,$query);
    }
    function insert(){
        $query="insert into Room values(null,'".$this->roomNumber."','".$this->EXT."');";
        mysqli_query($this->con,$query);
    }
    function delete(){
